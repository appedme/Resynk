...
CREATE TABLE users (
    ...
    preferences_theme TEXT DEFAULT 'system' CHECK (
        preferences_theme IN ('light', 'dark', 'system')
    ),
...
VALUES (
        ...
        'professional',
        '/templates/modern_professional_preview.png',
        '/templates/modern_professional_thumb.png',
        '{"layout": "single_column", "sections": ["personal", "summary", "experience", "education", "skills"], "styling": {"primary_color": "#2563eb", "font": "Inter"}}'
    ),
    (
        'creative_designer',
        'Creative Designer',
        'Showcase your creativity with this vibrant template',
        'creative',
        '/templates/creative_designer_preview.png',
        '/templates/creative_designer_thumb.png',
        '{"layout": "two_column", "sections": ["personal", "summary", "projects", "experience", "skills", "education"], "styling": {"primary_color": "#7c3aed", "font": "Poppins"}}'
    ),
    (
        'minimal_clean',
        'Minimal Clean',
        ...
        'minimal',
        '/templates/minimal_clean_preview.png',
        '/templates/minimal_clean_thumb.png',
        '{"layout": "single_column", "sections": ["personal", "summary", "experience", "education", "skills"], "styling": {"primary_color": "#64748b", "font": "Inter"}}'
    ),
    (
        'academic_researcher',
        'Academic Researcher',
        'Perfect for academic and research positions',
        'academic',
        '/templates/academic_researcher_preview.png',
        '/templates/academic_researcher_thumb.png',
        '{"layout": "single_column", "sections": ["personal", "summary", "education", "experience", "certifications", "achievements"], "styling": {"primary_color": "#1f2937", "font": "Times New Roman"}}'
    ),
    (
        'tech_modern',
        'Tech Modern',
        'Modern template optimized for tech professionals',
        'modern',
        '/templates/tech_modern_preview.png',
        '/templates/tech_modern_thumb.png',
        '{"layout": "two_column_sidebar", "sections": ["personal", "summary", "experience", "projects", "skills", "education"], "styling": {"primary_color": "#059669", "font": "JetBrains Mono"}}'
    );