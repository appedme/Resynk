                                    ...
                                    {savedResumes.length === 0 ? (
                                        ...
                                        <div className="space-y-2">
                                            {savedResumes.map((resume) => (
                                                <div
                                                    key={resume.id}
                                                    className={`p-3 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors ${currentResumeId === resume.id ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-700'
                                                        }`}
                                                >
